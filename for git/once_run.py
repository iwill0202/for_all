...
time = {u'夜間':[u'凌晨',u'晚間',u'零時',u'晚上',u'半夜',u'夜半',u'夜晚',u'零晨',u'午夜',u'淩晨',u'深夜',u'晚11時',u'晚8時',u'晚6時',u'晚7時',u'晚二十一時',u'晚九時',u'晚十一時',u'晚六時',u'晚22時',u'晚9時',u'晚10時',u'夜晚0時'],
...
u'一般道路':[u'省道',u'縣道',u'鄉道',u'市區道路',u'村里道路',u'產業道路',u'公共汽車招呼站',u'人行斑馬線',u'加油站入口',u'巷口',u'腳踏車陷入坑洞',u'圓環路口',u'廣場',u'地下道',u'機車待轉區',u'機車停等區',u'槽化線',u'黃色網狀槽化線',u'迴轉道',u'一般車道',u'直路',u'上坡路段',u'下坡路段',u'巷弄',u'彎曲路段',u'單行道',u'慢車道',u'幹線道',u'路口轉角',u'無號誌路口',u'路面邊坡',u'快車道',u'未劃分快慢車道之一般車道'],
u'快速道路':[u'收費站附近',u'國道一號',u'國道1號',u'國道五號',u'國道5號',u'國道三號',u'國道3號',u'國道6號',u'國道六號',u'高架道路',u'快速公路',u'匝道處',u'路肩',u'路緣',u'加速車道',u'減速車道',u'隧道'],
u'專用道路':[u'行人專用道路',u'機車專用道路',u'垃圾車專用道路',u'公車專用道路',u'砂石車專用道路',u'中油專用道路口',u'專用快車道',u'專用慢車道',u'機車優先道',u'行人穿越道',u'人行道'],
u'叉路口':[u'交岔路口',u'叉路',u'交叉路口',u'十字路口',u'「十」字型路口',u'Ｔ字型路口',u'T型路口',u'斜Ｔ字型路口',u'Ｌ型路口',u'L型路口',u'Ｙ字型路口',u'Ｙ字型三叉路',u'「卜」字型路口',u'「⊥」字型交岔路口',u'丁字交叉路口',u'丁字路口',u'丁字型路口',u'倒Ｔ字型交叉路口',u'三叉路口',u'五叉路口',u'五岔路口',u'四叉路口',u'多岔路口',u'路口交岔',u'無號誌之交岔口'],
u'路面滑':[u'油滑',u'泥濘',u'濕潤柏油路面',u'鐵板濕滑',u'濕滑的青苔',u'濕滑路面',u'柏油路面濕潤',u'路面濕潤'],
u'路面乾燥':[u'乾燥瀝青路面',u'路面乾燥',u'路面乾燥無缺陷'],
u'路面平整':[u'路面鋪裝柏油'],
u'路面有缺陷':[u'坑洞',u'道路高低不平',u'下陷龜裂']}
...
def run_all_data(pos):
    location = u'project\\%s\\'%pos
    all_files = os.path.abspath(location)
    num = 0
    for x in os.listdir(all_files)[0:]:
        with codecs.open(os.path.join(location,x),'r','utf-8') as f:
            content = f.read()
        with codecs.open(u'data_output_%s.txt'%pos,'a','utf-8') as fc:
            num+=1
            fc.write('%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\r\n'%(num,x,find_costs(content)\
                                                       ,find_law(content)\
